    ...
    <div class="container-shell">
      ...
      <div class="input">
        ...
        <input autocomplete="on" ref="playUrl"
          value="http://120.76.249.195:82/rtmpLive?port=1935&app=myapp&stream=mystream" />
      ...
      <div class="option">
        ...
        <!-- <input
          ...
          @change="restartPlay"
        /><span>点播模式</span> -->
        <input type="checkbox" ref="offscreen" v-model="forceNoOffscreen" @change="restartPlay" /><span>禁用离屏渲染</span>
