<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <!-- <el-input placeholder="" style="width:300px;" class="filter-item" @keyup.enter.native="handleFilter" /> -->
    ...
    <el-dialog title="新增设备" :visible.sync="dialogCreateVisible">
      <el-form :rules="createRules" :model="createList" label-position="left" label-width="80px"
    ...
    <el-dialog title="编辑" :visible.sync="dialogEditVisible">
      <el-form :rules="EditRules" :model="temp" label-position="left" label-width="180px"
        style="width: 72%; margin-left:10%;">
...
<script>
  ...
  export default {
    ...
    created() {
      this.listQuery.user = this.$store.getters.uuid
      this.getList()
    },
    methods: {
      getList() {
